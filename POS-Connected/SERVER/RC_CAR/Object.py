...
class Object_Detection():
    ...
    def __init__(self, steer):
        ...
        self.steer = steer
        print("Load YOLO...")
        self.net = load_net(b"./traffic.cfg", b"./traffic_200.weights", 0)
        self.meta = load_meta(b"./traffic.data")
        print("Complete")
    ...
    def Detection(self):
        ...
        results = detect(self.net, self.meta, b"../data/picamera/img.jpg")
        detect_list = []
        img = cv2.imread('../data/picamera/img.jpg')
        print('image loading...')
